...
<body class="signuppage">
                    ...
                    <div class="row">
                        <form action="" method="post" autocomplete="off" onsubmit="return validation();">
                            <div class="col s7 m7 l7 center">
                                ...
                                <input type="hidden" id="user_avatar_id" name="user_avatar_id" value="">
                                <div class="row">
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix">face</i>
                                        <input type="text" name="first_name" id="first_name">
                                        <label for="first_name">First Name</label>
                                        <span class="red-text text-accent-4 bold" id="firstname_msg"></span>
                                    </div>
                                    <div class="input-field col s6">
                                        <input type="text" name="last_name" id="last_name">
                                        <label for="last_name">Last Name</label>
                                        <span class="red-text text-accent-4 bold" id="lastname_msg"></span>
                                    </div>
                                    <div class="col s12 m12 l12">
                                        <div class="input-field">
                                            ...
                                            <span class="red-text text-accent-4 bold" id="username_msg"></span>
                                        </div>
                                    </div>
                                    <div class="col s12 m12 l12">
                                        <div class="input-field">
    ...
    <script type='text/javascript'>
        ...
        function validation()
        {
            ...
            /* Firstname validation */
                ...
                {
                    document.getElementById('firstname_msg').innerHTML = "** FirstName Invalid **";
                    return false;
                }
            ...
            {
                document.getElementById('lastname_msg').innerHTML = "** LastName Invalid **";
                return false;
            }
            ...
            {
                document.getElementById('username_msg').innerHTML = "** Username Invalid **";
                return false;
            }   
    ...
    <script>
        function changeImage(image, id){
            ...
            document.getElementById("user_avatar_id").value = id;
        }
